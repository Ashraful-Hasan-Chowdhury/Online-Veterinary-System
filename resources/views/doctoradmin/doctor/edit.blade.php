      ...
      <div class="card card-primary">
              ...
              <form action="{{ route('update.doctor',$doctor->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label class="mt-3" for="title">Visiting Days</label>
                    <select class="select2 border-primary" multiple="multiple"
                                            data-placeholder="Select Days" data-dropdown-css-class="select2-purple"
                                            name="days[]" style="width: 100%;">
                                            @foreach ($days as $row)
                                                <option value="{{$row->id}}"
                  ...
                  <div class="form-group">
                    <label class="mt-3" for="title">Visiting Hours</label>
                    <select class="select2 border-primary" multiple="multiple"
                                            data-placeholder="Select Visiting Hours" data-dropdown-css-class="select2-purple"
                                            name="times[]" style="width: 100%;">

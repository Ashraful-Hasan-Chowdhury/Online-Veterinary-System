...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add New Pharmacy</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="col-md-6">
    ...
    <div class="col-md-6">
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('store.pharmacy') }}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                  <div class="form-group" >
                    <label for="exampleInputEmail1">Pharmacy Name</label>
                    <input name="name" type="text" v-model="place.name" class="form-control" placeholder="Enter pharmacy Name">
                  </div>
                  <div class="form-group" >

...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add New Hospital</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form action="{{ route('store.hospital') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group" >
                    ...
                    <input name="name" type="text" v-model="place.name" class="form-control" placeholder="Enter hospital Name">
                  </div>
                  <div class="form-group" >
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="direction" type="text" class="form-control" rows="5" placeholder="Write the directions of going the hospital"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Desciption</label>
                    <textarea name="desciption" type="text" class="form-control" rows="5" placeholder="Write hospital desciption"></textarea>
                  </div>

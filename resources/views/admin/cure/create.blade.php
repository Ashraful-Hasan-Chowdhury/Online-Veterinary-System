...
{{-- Vue id is here --}}
    ...
    <div class="col-md-10 offset-1">
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('store.cure') }}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label class="mt-3" for="title">Diseases</label>
                    <select class="select2 border-primary" multiple="multiple"
                                            data-placeholder="Select Diseases" data-dropdown-css-class="select2-purple"
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="cures" id="editor"></textarea>
                  </div>

  ...
  <div class="container-fluid">
    <center><h5 class="m-0 font-weight-bold text-info"><i class="fa fa-map-marker" aria-hidden="true"></i> বর্তমান অবস্থানঃ 
          ...
          <div class="col-md-8 offset-2">
                <div class="card">
                      <div class="card-header py-3 ">
                        <h5 class="m-0 font-weight-bold text-dark">ফার্মেসী অনুসন্ধান করুন</h5>
                      </div>
        ...
        <div class="row">
            ...
            <div class="card-header py-3 ">
              <h5 class="m-0 font-weight-bold text-dark">পার্শ্ববর্তী ফার্মেসী সমূহ</h5>
            </div>
            <div class="card-body">
              <br>
...
export default {
  ...
  methods: {
    ...
    getResults(page = 1) {
      axios.post('show-pharmacy?page='+page,{
                    lat:this.center.lat,
                    lng:this.center.lng
                })
        .then(response => {
    ...
    viewDetails(placeid){
        axios.get('details-pharmacy/'+placeid)
                .then(response => { 
